    ...
    <div id="page">
        <div class="container">
            <div class="welcome-header">
                ...
                <p>Reserve our beautiful party halls for your special events</p>
            </div>
            ...
            <div class="info-box">
                <p>Here you can reserve our party halls for your special occasions. For more information <a href="contactus.php">contact us</a>.</p>
            </div>
            
            <!-- Party Hall Gallery -->
            <div class="hall-gallery">
                <?php while ($hall=mysqli_fetch_array($partyhalls)): ?>
                <div class="hall-card">
                    <img src="images/<?php echo $hall['partyhall_photo']; ?>" alt="<?php echo $hall['partyhall_name']; ?>" class="hall-image">
                    <div class="hall-info">
                        <h3 class="hall-name"><?php echo $hall['partyhall_name']; ?></h3>
                        <div class="hall-capacity">
                            <i class="fas fa-users"></i>
                            Capacity: <?php echo $hall['partyhall_capacity']; ?> 1000 people
                        </div>
                        <p><?php echo $hall['partyhall_description']; ?>enhanced security for any occasion</p>
                    </div>
                </div>
                <?php endwhile; ?>
            </div>
            ...
            <div class="reservation-form">
                ...
                <form name="partyhallForm" id="partyhallForm" method="post" action="reserve-exec.php?id=<?php echo $_SESSION['SESS_MEMBER_ID'];?>" onsubmit="return partyhallValidate(this)">
                    <div class="form-group">
                        <label for="partyhall">Party Hall</label>
                        <select name="partyhall" id="partyhall" class="form-control">
                            <option value="select">- select party hall -</option>
                            <?php 
                            mysqli_data_seek($partyhalls, 0); // Reset pointer to beginning
                            while ($row=mysqli_fetch_array($partyhalls)): 
                            ?>
                                <option value="<?php echo $row['partyhall_id']; ?>"><?php echo $row['partyhall_name']; ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    ...
                    <button type="submit" class="btn btn-block">Reserve Party Hall</button>
                </form>
            </div>
        </div>
    </div>
