...
<div id="page">
  ...
  <div id="center">
    ...
    <div class="success-box">
      <p>Thank you for registering with <?php echo APP_NAME ?>!</p>
      <p><a href="login-register.php">Click Here</a> to login to your account and start exploring our delicious offerings.</p>
    </div>
  </div>
