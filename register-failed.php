...
<div id="page">
  ...
  <div id="center">
    ...
    <div class="error-box">
      ...
      <p>You are seeing this page because your attempt to create a new account has failed. You have used an email address that is already in use.</p>
      <p><a href="login-register.php">Click Here</a> to try again. Or <a href="JavaScript: resetPassword()">Click Here</a> to reset your password.</p>
    </div>
  </div>
